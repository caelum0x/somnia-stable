  ...
  return (
    <footer className="border-t border-white/10 bg-gradient-to-b from-transparent to-black/20">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <div className="cyber-card px-3 py-1.5 md:px-4 md:py-2 text-sm">
        ...
        <div className="mt-10 pt-6 md:mt-12 md:pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6 w-full md:w-auto text-center md:text-left">
              <p className="text-gray-400 text-sm md:text-base">
                &copy; 2025 SomniaVault. Built on Somnia Network.
              </p>
            ...
            <div className="flex space-x-3 md:space-x-4">
              <a href="#" className="text-gray-400 hover:text-white transition-colors group">
                ...
                <div className="w-9 h-9 md:w-10 md:h-10 rounded-lg bg-gradient-to-br from-blue-500/20 to-cyan-500/20 flex items-center justify-center group-hover:scale-110 transition-transform">
